# Final Test Report
this test report will go over the results of the indicator survey and the final playtest results.
---

### Test Report: Final Playtest for [Your Game Title]

This report outlines the findings from the final playtest of [Your Game Title]. The playtest aimed to gather feedback on controller support, ability indicators, the blackhole and laser abilities, and the new enemy, the Berserker. Participants played the game on a laptop using either a controller or keyboard/mouse, and their feedback was collected through a survey.

---

## 1. Input Method Preferences

Participants were asked which input method they preferred for playing the game. The majority preferred the keyboard/mouse, with only one participant opting for the controller. This indicates a general favor towards traditional input methods over the controller.
...
When asked if the controller provided better control compared to the keyboard/mouse, the responses averaged at 2.00. Most participants felt the controller did not offer better control, with a few noting no significant difference. 
...
The laser ability was primarily used to deal damage, often in combination with the blackhole ability to maximize effectiveness.
...
The Berserker’s animations received a moderate rating, with an average of 3.17. Feedback suggested some issues with animation fluidity, particularly during charge attacks.
