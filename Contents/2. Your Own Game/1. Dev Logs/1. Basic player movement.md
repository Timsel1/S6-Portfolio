# How can a movement system prototype be created that will showcase the feel for the movement in crusader?
...
The code will be reviewed when a pull request is created and after this, depending on if changes need to be made, the controller will be tested by my group members. At the end of the sprint the controller will be tested by people outside of the group to collect feedback from other industry professionals.
