...
Sonic & Sega All-Stars Racing is a kart racing game developed by Sumo Digital and published by Sega. Released in 2010, it features characters from various Sega franchises, including Sonic the Hedgehog, Super Monkey Ball, and Jet Set Radio.
(All information is aquired by playing the game)

### Aesthetics 
Sonic and Sega All Stars Racing’s aesthetics are:
- Competition:  
Since Sonic and Sega All Stars Racing is a racing game, people naturally want to win, beating your opponents is one of the goals of the game.

- Fellowship:  
Sonic and Sega All Stars Racing was released on multiple home consoles. The game could be played with friends and family in the split screen mode.

- Challenge:  
Players will improve over time, one of the challenges in the game are its time trials. Another challenge are its missions, which get progressively harder the farther you get. Trying to get the highest score on all challenges is no easy task.
...
- Mastering character-specific abilities:  
Each character has unique abilities that players can utilize strategically during races. Understanding and mastering these abilities adds depth to gameplay and allows players to gain an advantage over their opponents. 

- Balancing risk and reward:  
Certain actions, such as taking risky shortcuts or attempting aggressive maneuvers, carry potential rewards but also pose risks of failure or penalty. Players must weigh these factors and make split-second decisions during races, adding tension and excitement to each lap.

### Mechanics
- Steering:  
You steer left and right with the left analog stick to get around corners.
- Accelerate:  
Makes the player go forward, building up speed until the max speed is reached. 
- Brake:  
Slows down the kart until it stops. 
- Reverse:  
Hold the brake button to go backwards.
- Fire weapon:  
Uses the item that is in the player's item slot at the time. 
- Drift:  
Drivers drift to keep the vehicle's speed and take corners more easily, with the benefit of getting a boost. The longer the player drifts the longer the boost will last.
- Character attributes and vehicle statistics:   
Each character and vehicle combination has unique stats affecting speed, acceleration, and handling, influencing player choices and strategies.
- Tricks:  
Drivers can pull off a trick when they jump in order to gain a momentary Mini-Turbo.They obtain a speed boost when landing. The more tricks that are performed, the longer the boost will last.
- Rocket Start:  
Drivers can perform a speed boost when a race begins. If drivers hold down the corresponding acceleration button right after the countdown timer displays the number 2, then they will receive an extra speed boost when the word "GO!" appears on the screen. However, if drivers hold down the button for too long, when the final beep is heard, their engine bursts and they get an even worse start than a regular one and take a few seconds to recover.
...
## Conclusion
In conclusion, while Mario Kart, Sonic and Sega All Stars Racing, and Pac-Man Rally offer distinct racing experiences, they share a foundation built upon core driving mechanics that define the genre.
Acceleration, steering, braking, and reversing serve as the backbone of gameplay in all three titles. These fundamental mechanics provide players with control over their vehicles, allowing them to navigate the intricacies of each track and compete against opponents.  

Moreover, drifting emerges as a central and shared mechanic across all three games. By mastering the art of controlling the drifting mechanic, players can maintain speed through corners and gain boosts, adding an element of skill and strategy to the racing experience. In all 3 games drifting remains integral to achieving success on the track.

Based on this for this project I will focus on the acceleration, top speed, steering, drifting and boosting mechanics.
